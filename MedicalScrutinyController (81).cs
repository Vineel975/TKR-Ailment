                        ...
                        try
                        {
                            if (!string.IsNullOrWhiteSpace(analysisJson))
                            {
                                ...
                                if (_aa != null)
                                {
                                    ...
                                    // When eligible, ClaimAI includes a ready-to-store billingState
                                    // (approvalBasis etc). Persisting it to BillingStateJson makes the
                                    // correct Approvals checkbox ALREADY checked when the doctor opens
                                    // the claim.
                                    if (autoApproved == true && _aa.billingState != null)
                                    {
