    ...
    public class MedicalScrutinyController : Controller
    {
            ...
            out string saveStatus, out string saveError)
        {
            ...
            try
            {
                ...
                // Approved facility: ClaimAI leaves it null (browser-only), so resolve it
                // here (default rule: approved = availed). Applied to clinical + hosp.
                ...
                try
                {
                    ...
                    SaveClinicalDetailsForClaimAI(
                        claimId.ToString(), diagnosis, lineOfTreatment,
